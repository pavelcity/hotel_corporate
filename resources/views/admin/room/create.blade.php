					...
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Создание Номера</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('admin.room.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf

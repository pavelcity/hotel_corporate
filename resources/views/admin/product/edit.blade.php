...
@section('title', 'Админка номер | Edit')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Редактировать номер</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Редактировать номер</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('admin.product.update', $product->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<label for="title">Редактировать номер *</label>
				<input class="form-control @error('title') error_line @enderror" id="title" name="title" type="text" placeholder="" value="{{ $product->title }}">
				@error('title')
			...
			<div class="mb-3">
				...
				<input class="form-control @error('short') error_line @enderror" id="short" name="short" type="text" placeholder="" value="{{ $product->short }}">
				@error('short')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control @error('price') error_line @enderror" id="price" name="price" type="text" placeholder="" value="{{ $product->price }}">
				@error('price')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
			...
			<div class="form-group mb-3">
				...
				<textarea id="summernote" name="descr" class="form-control" rows="10" cols="3">{{ $product->descr }}</textarea>
			</div>
			...
			<input type="hidden" name="old_avatar" value="{{ $product->avatar }}">


			
			<div class="mt-4">
				<img id="showPic" style="width: 500px; margin-bottom:30px;" src="{{ asset( $product->avatar ?? 'uploads/not_image.jpg') }}" alt="">
			</div>
			...
			<div class="input-group mb-5 mt-5">
				...
				<div class="wrapVnomere">
					...
					<div class="custom-control custom-switch  mb-3">
						...
						type="checkbox" 
						value="1" 
						@if($product->is_wifi == 1) checked @endif
						id="wifi">
					...
					<div class="custom-control custom-switch  mb-3">
						...
						type="checkbox" 
						value="1" 
						@if($product->is_saife == 1) checked @endif
						id="is_saife">
					...
					<div class="custom-control custom-switch mb-3">
						...
						type="checkbox" 
						value="1" 
						@if($product->is_conditioner == 1) checked @endif
						id="is_conditioner">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_bar" 
						value="1"
						@if($product->is_bar == 1) checked @endif 
						id="is_bar">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_tv" 
						value="1" 
						@if($product->is_tv == 1) checked @endif 
						id="is_tv">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_garderob" 
						value="1" 
						@if($product->is_garderob == 1) checked @endif 
						id="is_garderob">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_utug" 
						value="1" 
						@if($product->is_utug == 1) checked @endif 
						id="is_utug">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_gladilka" 
						value="1" 
						@if($product->is_gladilka == 1) checked @endif 
						id="is_gladilka">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_otoplenie" 
						value="1" 
						@if($product->is_otoplenie == 1) checked @endif 
						id="is_otoplenie">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_kover" 
						value="1" 
						@if($product->is_kover == 1) checked @endif 
						id="is_kover">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_kattle" 
						value="1" 
						@if($product->is_kattle == 1) checked @endif 
						id="is_kattle">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_table" 
						value="1" 
						@if($product->is_table == 1) checked @endif 
						id="is_table">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_sputniktv" 
						value="1" 
						@if($product->is_sputniktv == 1) checked @endif 
						id="is_sputniktv">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_rosetka" 
						value="1" 
						@if($product->is_rosetka == 1) checked @endif 
						id="is_rosetka">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_kitchen" 
						value="1" 
						@if($product->is_kitchen == 1) checked @endif 
						id="is_kitchen">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_stiralka" 
						value="1" 
						@if($product->is_stiralka == 1) checked @endif 
						id="is_stiralka">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_holodilnik" 
						value="1" 
						@if($product->is_holodilnik == 1) checked @endif 
						id="is_holodilnik">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_kofemachina" 
						value="1" 
						@if($product->is_kofemachina == 1) checked @endif 
						id="is_kofemachina">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						value="1" 
						@if($product->is_mikrovolnovka == 1) checked @endif 
						id="is_mikrovolnovka">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_tarelki" 
						value="1" 
						@if($product->is_tarelki == 1) checked @endif 
						id="is_tarelki">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_posudomoika" 
						value="1" 
						@if($product->is_posudomoika == 1) checked @endif 
						id="is_posudomoika">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						value="1" 
						@if($product->is_electrplitka == 1) checked @endif 
						id="is_electrplitka">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						value="1" 
						@if($product->is_obedennytable == 1) checked @endif 
						id="is_obedennytable">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_sofa" 
						value="1" 
						@if($product->is_sofa == 1) checked @endif 
						id="is_sofa">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_gostugolok" 
						value="1" 
						@if($product->is_gostugolok == 1) checked @endif 
						id="is_gostugolok">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_kamin" 
						value="1" 
						@if($product->is_kamin == 1) checked @endif 
						id="is_kamin">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_terassa" 
						value="1" 
						@if($product->is_terassa == 1) checked @endif 
						id="is_terassa">
					...
					<div class="custom-control custom-switch  form-check-inline mb-3">
						...
						name="is_selfbasein" 
						value="1" 
						@if($product->is_selfbasein == 1) checked @endif 
						id="is_selfbasein">

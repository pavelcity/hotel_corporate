...
@section('title', 'Админка Мета-данные (seo) | Редактировать')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Редактировать Мета-данные (seo)</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Редактировать Мета-данные (seo)</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="row">
	<div class="col-12">
		<div style="display: flex; justify-content:space-between; align-items:center;">
			<h3>Редактировать Мета-данные (seo)</h3>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('admin.meta.update', $meta->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf

			<div class="mb-3">
				<label for="keywords">Ключевые слова </label>
				<input class="form-control @error('keywords') error_line @enderror" id="keywords" name="keywords" type="text" placeholder="" value="{{ $meta->keywords }}">
				@error('keywords')
			...
			<div class="mb-3">
				...
				<input class="form-control @error('description') error_line @enderror" id="description" name="description" type="text" placeholder="" value="{{ $meta->description }}">
				@error('description')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>

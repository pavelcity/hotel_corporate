		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Создать Услуги</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Создание Услуги</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('admin.uslugi.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
			...
			<div class="mb-5">
				...
				<textarea id="summernote" name="descr" class="form-control" rows="6" cols="3">{{ old('descr') }}</textarea>
				@error('descr')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
